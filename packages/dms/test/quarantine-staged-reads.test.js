...
function exerciseStagedReadDeny(storage, { restart } = {}) {
...
test("DMS H1 file adapter denies every staged and committed read after durable tombstone across restart", (t) => {
  ...
  exerciseStagedReadDeny(storage, { restart: (digest) => {
...
test("DMS H1 local adapter denies staged digest/stat and supports shared-authority restart readback", () => {
