...
const APPEND_ONLY_RECORD_TYPES = new Set(["CriticalPathRun", "UiAdjudication"]);

export const UI_READINESS_DOMAIN_DESCRIPTOR = createRecordDomainDescriptor({
  domain_id: "ui-readiness",
