...
const viewChecks = [
  {
    ...
    expectText: "matter command center",
  ...
  { name: "portal-live", url: "/?locale=en&view=portal&data=live&ctx=allow", expectText: "External Access Boundary" },
  { name: "readiness-live", url: "/?locale=en&view=readiness&data=live&ctx=allow", expectText: "UI Runtime Boundary" },
  { name: "ops-live", url: "/?locale=en&view=ops&data=live&ctx=allow", expectText: "Enterprise Boundary" },
  { name: "intake-live", url: "/?locale=en&view=intake&data=live&ctx=allow", expectText: "Opportunity Pipeline" },
  { name: "finance-live", url: "/?locale=en&view=finance&data=live&ctx=allow", expectText: "Time Entries" },
  { name: "profiles-live", url: "/?locale=en&view=profiles&variant=userList&data=live&ctx=allow", expectText: "Matching Profiles" },
  { name: "people-live", url: "/?locale=en&view=people&data=live&ctx=allow", expectText: "People Runtime" },
  { name: "analytics-live", url: "/?locale=en&view=analytics&data=live&ctx=allow", expectText: "CMP-G8 Analytics Runtime" },
  { name: "ask-live", url: "/?locale=en&view=ask&data=live&ctx=allow", expectText: "CMP-G9 AI Review Queue" },
  { name: "admin", url: "/?locale=en&view=admin", expectText: "Organization Settings" },
