...
const windowsExecutablePath = path.join(windowsRoot, `${internalChannel.windowsExecutableName}.exe`);
...
const expectedSignature = createHmac("sha256", internalChannel.receiptSigningKey).update(manifestHash).digest("hex");
