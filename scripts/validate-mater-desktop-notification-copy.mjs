...
const probes = {
  client_names: templateFindings({ probe: { title: "Matter for {{clientName}}", body: "Open mater" } }),
  matter_names: templateFindings({ probe: { title: "Matter {{matterName}} updated", body: "Open mater" } }),
  document_names: templateFindings({ probe: { title: "Document {{documentName}}", body: "Open mater" } }),
  snippets: templateFindings({ probe: { title: "mater update", body: "Snippet: privileged text" } }),
  sensitive_deadlines: templateFindings({ probe: { title: "Deadline tomorrow", body: "Open mater" } }),
