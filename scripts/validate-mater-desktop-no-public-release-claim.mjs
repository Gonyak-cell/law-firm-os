...
const scanRoots = ["docs/lazycodex/evidence/mater-desktop", "docs/desktop"];
...
assert.deepEqual(findings, [], "mater desktop public release / go-live / owner approval claim found without receipt");
