...
const ledgerPath = "docs/desktop/matter-desktop-loop-tuw-ledger.json";
const ledger = JSON.parse(await readFile(ledgerPath, "utf8"));

assert.equal(ledger.schema, "law-firm-os.matter-desktop.loop-tuw-ledger.v0.1");
assert.equal(ledger.product_display_name, "matter");
