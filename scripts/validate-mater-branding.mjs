...
assert.match(brandSource, /PRODUCT_BRAND\s*=\s*"mater"/, "PRODUCT_BRAND must be mater");
assert.match(brandSource, /UI_BRAND\s*=\s*"mater by AMIC"/, "UI_BRAND must be mater by AMIC");
assert.match(namingRules, /Product brand \| mater/, "mater product brand rule is missing");
