...
export const JSON_POSTGRES_PRODUCTION_OUTLOOK_RUNTIME_ENTRIES = Object.freeze([
  ...
  "apps/api/src/external-read-credential-vault.js",
  "apps/api/src/external-read-provider-pack-config.js",
  "apps/api/src/external-read-runtime-context.js",
  ...
  "apps/api/src/internal-unsigned-installation-authority.js",
  "apps/api/src/internal-unsigned-installation-runtime-context.js",
  "apps/api/src/internal-unsigned-update-broker.js",
  ...
  "apps/api/src/native-matter-export-runtime.js",
  ...
  "apps/api/src/vault-corporate-permission.js",
  ...
  "packages/email-dms/src/internal-unsigned-installation-authority-catalog.js",
  "packages/email-dms/src/internal-unsigned-installation-authority-readback.js",
  "packages/email-dms/src/internal-unsigned-s3-version-authority-catalog.js",
  ...
  "packages/email-dms/src/migrations/010_internal_unsigned_installation_authority.sql",
  "packages/email-dms/src/migrations/011_internal_unsigned_s3_version.sql",
  "packages/email-dms/src/migrations/index.js",
  ...
  "packages/hrx/src/member-photo-storage.js",
  ...
  "packages/hrx/src/migrations/049_hrx_directory_authority.sql",
  ...
  "packages/integrations-core/src/external-read-onboarding-repository.js",
  "packages/integrations-core/src/external-read-provider-onboarding.js",
  "packages/integrations-core/src/external-read-provider-pack.js",
  ...
  "packages/persistence/src/postgres/migrations/016_dms_corporate_workspace.sql",
  ...
  "packages/runtime-auth/src/internal-unsigned-installation-attestation.js",
