...
export function validateM365ReleaseReceipt(receipt, options) {
  ...
  validateM365Runtime(receipt, options, {
    centralObservedAt: central.completedAt,
    controls: receipt.execution_control,
    monitoringObservedAt: controlProofs.monitoring.completedAt,
    rollbackObservedAt: controlProofs.rollback.completedAt,
    validationCutoff: envelope.validationCutoff,
  });
