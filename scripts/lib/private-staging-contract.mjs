...
function validateSecretsAndInternalAuth(resources, template) {
  ...
  }), "SES endpoint policy must delegate only ses:SendEmail to the exact API Lambda assumed-role session principal, exact sender, and every active synthetic recipient using Resource *");
