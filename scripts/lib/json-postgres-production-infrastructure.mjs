...
export const JSON_POSTGRES_SCHEMA_GOVERNANCE_LAYER_ARN_PATTERN = "^(disabled|arn:aws:lambda:ap-northeast-2:770880870480:layer:lawos-schema-governance-(2026090601|2026090602|2026090603)-[0-9a-f]{64}:[1-9][0-9]*)$";
