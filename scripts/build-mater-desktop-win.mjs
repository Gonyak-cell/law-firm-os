...
const artifactPath = join(distRoot, `mater-internal-${packageJson.version}-win-installer-manifest.json`);
const signaturePath = `${artifactPath}.sig`;
const receiptPath = join(repoRoot, "docs/lazycodex/evidence/mater-desktop/artifacts/windows-build.md");
...
const artifact = {
  productName: "mater",
  appId: "com.amic.mater.desktop.internal",
...
const signature = createHmac("sha256", "mater-internal-nonproduction-signing-key").update(installerHash).digest("hex");
...
Installer manifest: \`apps/desktop/dist/win/mater-internal-${packageJson.version}-win-installer-manifest.json\`
...
- signature file: \`apps/desktop/dist/win/mater-internal-${packageJson.version}-win-installer-manifest.json.sig\`
...
console.log(
  JSON.stringify(
    {
      verdict: "PASS",
      artifact: "apps/desktop/dist/win/mater-internal-win-installer-manifest.json",
      receipt: "docs/lazycodex/evidence/mater-desktop/artifacts/windows-build.md",
      signing_identity: "mater-internal-nonproduction detached signature",
