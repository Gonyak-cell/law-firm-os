export const backendCapabilities = Object.freeze([
  ...
  },
  {
    ...
    readEndpoints: [
      ...
      "GET /api/hrx/people/members/:id/daily-brief",
      "GET /api/hrx/people/members/:id/outlook-connection",
      "GET /api/hrx/people/team-operations",
      "GET /api/hrx/employee-user-links",
      "GET /api/hrx/documents",
      "GET /api/hrx/attendance/correction-requests",
      "GET /api/hrx/leave",
    ...
    actionEndpoints: [
      ...
      "POST /api/hrx/people/members/:id/outlook-connection",
      "DELETE /api/hrx/people/members/:id/outlook-connection",
      "POST /api/hrx/leave",
      "POST /api/hrx/attendance/:id/correction-requests",
      "POST /api/hrx/attendance/correction-requests/:id/:decision",
      ...
      "POST /api/hrx/lifecycle/offboarding/:id/evidence",
