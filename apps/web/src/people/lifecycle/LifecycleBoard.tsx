...
export function LifecycleBoard() {
  ...
  let body;
  if (result === null) {
    body = <div className="live-data-state live-data-loading">입사·퇴사 업무를 불러오는 중입니다</div>;
  } else if (result.kind === "error") {
    body = <div className="live-data-state live-data-error">입사·퇴사 업무를 불러오지 못했습니다.</div>;
  } else {
    body = (
      <>
        <DataTable
  ...
  return (
    <Panel id="people-lifecycle" className="people-panel span-2" title="입사·퇴사 업무" meta="구성원 변경">
