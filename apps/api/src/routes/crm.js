export const CRM_INTAKE_ROUTE_POLICIES = Object.freeze([
  ...
  Object.freeze({
    method: "POST",
    pattern: /^\/api\/crm\/inquiries\/([^/]+)\/consultations$/,
    action: "crm:consultation:create",
    resource_type: "crm_inquiry",
  }),
  ...
  Object.freeze({ method: "POST", pattern: /^\/api\/crm\/activities$/, action: "crm:activity:write", resource_type: "crm_activity" }),
  Object.freeze({ method: "PATCH", pattern: /^\/api\/crm\/activities\/([^/]+)$/, action: "crm:activity:patch", resource_type: "crm_activity" }),
  Object.freeze({ method: "GET", pattern: /^\/api\/crm\/proposals$/, action: "crm:proposal:read", resource_type: "crm_proposal" }),
  Object.freeze({ method: "POST", pattern: /^\/api\/crm\/proposals$/, action: "crm:proposal:write", resource_type: "crm_proposal" }),
  Object.freeze({ method: "PATCH", pattern: /^\/api\/crm\/proposals\/([^/]+)$/, action: "crm:proposal:patch", resource_type: "crm_proposal" }),
  ...
  Object.freeze({ method: "GET", pattern: /^\/api\/crm\/client-settings$/, action: "crm:client_settings:read", resource_type: "crm_client_policy" }),
  Object.freeze({ method: "PATCH", pattern: /^\/api\/crm\/client-settings\/([^/]+)$/, action: "crm:client_settings:patch", resource_type: "crm_client_policy" }),
