export const ADMIN_PERMISSION_ROUTE_POLICIES = Object.freeze([
  Object.freeze({
    ...
    action: "admin_permission:permission_set:read",
    resource_type: "admin_permission_set",
  }),
  Object.freeze({
    method: "POST",
    pattern: /^\/api\/admin\/permission-sets$/,
    action: "admin_permission:permission_set:write",
    resource_type: "admin_permission_set",
  }),
  Object.freeze({
    method: "PATCH",
    pattern: /^\/api\/admin\/permission-sets\/([^/]+)$/,
    action: "admin_permission:permission_set:patch",
    resource_type: "admin_permission_set",
  }),
  Object.freeze({
    method: "GET",
    pattern: /^\/api\/admin\/permission-assignments$/,
    action: "admin_permission:permission_assignment:read",
    resource_type: "admin_permission_assignment",
  }),
  Object.freeze({
    method: "POST",
    pattern: /^\/api\/admin\/permission-assignments$/,
    action: "admin_permission:permission_assignment:write",
    resource_type: "admin_permission_assignment",
  }),
  Object.freeze({
    method: "DELETE",
    pattern: /^\/api\/admin\/permission-assignments\/([^/]+)$/,
    action: "admin_permission:permission_assignment:revoke",
    resource_type: "admin_permission_assignment",
  }),
  Object.freeze({
    method: "GET",
    pattern: /^\/api\/admin\/object-manager\/objects$/,
    action: "admin_permission:object_manager:read",
    resource_type: "admin_object_definition",
  }),
  Object.freeze({
    method: "GET",
    pattern: /^\/api\/admin\/object-manager\/objects\/([^/]+)\/fields$/,
    action: "admin_permission:object_manager:field_read",
    resource_type: "admin_field_policy",
  }),
  Object.freeze({
    method: "PATCH",
    pattern: /^\/api\/admin\/object-manager\/objects\/([^/]+)\/fields\/([^/]+)$/,
    action: "admin_permission:object_manager:patch",
    resource_type: "admin_field_policy",
  }),
  Object.freeze({
    method: "GET",
    pattern: /^\/api\/admin\/connected-apps$/,
    action: "admin_permission:connected_app:read",
    resource_type: "admin_connected_app",
  }),
  Object.freeze({
    method: "POST",
    pattern: /^\/api\/admin\/connected-apps$/,
    action: "admin_permission:connected_app:write",
    resource_type: "admin_connected_app",
  }),
  Object.freeze({
    method: "POST",
    pattern: /^\/api\/admin\/connected-apps\/([^/]+)\/disable$/,
    action: "admin_permission:connected_app:disable",
    resource_type: "admin_connected_app",
  }),
  Object.freeze({
    method: "GET",
    pattern: /^\/api\/admin\/audit$/,
    action: "admin_permission:audit:read",
