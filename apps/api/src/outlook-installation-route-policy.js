...
const ROUTES = [
  ...
  ["outlook.vault.email.save", "POST", "/api/outlook/vault/email/save", C.protectedOperation],
  ["outlook.vault.sent.save", "POST", "/api/outlook/vault/sent/save", C.protectedOperation],
  ...
  ["outlook.vault.attachments.save", "POST", "/api/outlook/vault/attachments/save", C.protectedOperation],
  ["outlook.vault.source.status", "POST", "/api/outlook/vault/source/status", C.protectedOperation],
  ["outlook.vault.attachments.authorize", "POST", "/api/outlook/vault/attachments/authorize", C.protectedOperation],
  ["outlook.vault.attachments.delivery", "GET", "/api/outlook/vault/attachments/delivery/:delivery_token", C.providerWebhookExempt],
  ["outlook.vault.attachments.complete", "POST", "/api/outlook/vault/attachments/complete", C.protectedOperation],
