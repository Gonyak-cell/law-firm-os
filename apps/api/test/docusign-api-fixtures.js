...
export async function docusignRuntime({ authorizeMatter = async () => ({ allowed: true, authority_binding: AUTHORITY_BINDING }), prepare = true, webhookRequestResolver, repository: providedRepository, adapter: providedAdapter } = {}) {
