...
| LCX7-RI-09 | real_external_receipt_received | M365/Graph receipt recorded; not go-live, not production cutover, not final domain launch acceptance |
| LCX7-RI-10 | real_external_receipt_received | HR real data receipt recorded; not go-live, not production cutover, not final domain launch acceptance |
| LCX7-RI-11 | real_external_receipt_received | Vault import/sync receipt recorded; not go-live, not production cutover, not final domain launch acceptance |
| LCX7-RI-12 | real_external_receipt_received | AI policy receipt recorded; not go-live, not production cutover, not final domain launch acceptance |
...
| `npm run launch:external-receipts:validate` | PASS | `real_external_receipt_count: 8`; `pending_external_receipt_count: 0`; launch/go-live boundary false |
