...
| LCX7-RI-12 | pending_external_receipt | Remaining owner/external receipt lane still blocks launch closure |
...
| `npm run launch:external-receipts:validate` | PASS | `real_external_receipt_count: 7`; `pending_external_receipt_count: 1`; launch/go-live boundary false |
