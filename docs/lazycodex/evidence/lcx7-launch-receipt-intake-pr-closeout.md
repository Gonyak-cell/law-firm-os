...
| LCX7-RI-07 through LCX7-RI-12 | pending_external_receipt | Remaining owner/external receipt lanes still block launch closure |
...
| `npm run launch:external-receipts:validate` | PASS | `real_external_receipt_count: 2`; `pending_external_receipt_count: 6`; launch/go-live boundary false |
