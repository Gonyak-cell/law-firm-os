...
| MDT-P5-W01-T04 | complete | `apps/desktop/src/main/deepLinks.js`, `apps/desktop/test/deep-link-open-audit.test.mjs`, `docs/desktop/matter-desktop-deep-link-audit-map.md` |
| MDT-P5-W02-T01 | complete | `docs/desktop/matter-desktop-notification-policy.md` |
| MDT-P5-W02-T02 | complete | `apps/desktop/src/main/notifications.js`, `apps/desktop/test/notification-route-intent.test.mjs` |
| MDT-P5-W02-T03 | complete | `scripts/validate-matter-desktop-notification-copy.mjs` |
...
git diff --check -- contracts/desktop-deep-link-contract.json scripts/validate-desktop-deep-link-contract.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
git diff --check -- apps/desktop/src/main/deepLinks.js apps/desktop/test/deep-link-parser.test.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
node apps/desktop/test/deep-link-parser.test.mjs
git diff --check -- apps/desktop/src/main/deepLinks.js apps/desktop/test/deep-link-deny.test.mjs apps/desktop/test/deep-link-parser.test.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
- Added `docs/desktop/matter-desktop-deep-link-audit-map.md`.
...
node apps/desktop/test/deep-link-parser.test.mjs
node apps/desktop/test/deep-link-deny.test.mjs
git diff --check -- apps/desktop/src/main/deepLinks.js apps/desktop/test/deep-link-open-audit.test.mjs docs/desktop/matter-desktop-deep-link-audit-map.md docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
- Added `docs/desktop/matter-desktop-notification-policy.md`.

Check:

```bash
rg -n "forbid|client names|matter names|document names|lock screen" docs/desktop/matter-desktop-notification-policy.md
git diff --check -- docs/desktop/matter-desktop-notification-policy.md docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
node apps/desktop/test/deep-link-deny.test.mjs
git diff --check -- apps/desktop/src/main/notifications.js apps/desktop/test/notification-route-intent.test.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
- Added `scripts/validate-matter-desktop-notification-copy.mjs`.

Check:

```bash
node scripts/validate-matter-desktop-notification-copy.mjs
git diff --check -- scripts/validate-matter-desktop-notification-copy.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
...
rg -n "MDT-P5|route-only|denylist|notification" docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
git diff --check -- docs/lazycodex/evidence/matter-desktop/lcx-desk-05-deeplink-notification.md
```
