...
| TUW | Status | Evidence |
| --- | --- | --- |
| MDT-P6-W01-T01 | complete | `docs/desktop/matter-desktop-packaging-decision.md` |
| MDT-P6-W01-T02 | complete | `apps/desktop/electron-builder.yml`, `scripts/validate-matter-desktop-packaging.mjs`, `apps/desktop/build/icon.svg` |
| MDT-P6-W01-T03 | complete | `docs/lazycodex/evidence/matter-desktop/artifacts/macos-build.md`, `scripts/build-matter-desktop-mac.mjs` |
| MDT-P6-W01-T04 | complete | `docs/lazycodex/evidence/matter-desktop/artifacts/windows-build.md`, `scripts/build-matter-desktop-win.mjs` |
| MDT-P6-W02-T01 | complete | `docs/desktop/matter-desktop-update-policy.md` |
| MDT-P6-W02-T02 | complete | `apps/desktop/src/main/updates.js`, `apps/desktop/test/update-rollback.test.mjs` |
| MDT-P6-W02-T03 | complete | `docs/desktop/matter-desktop-license-audit.md` |
...
- Added `docs/desktop/matter-desktop-packaging-decision.md`.

Check:

```bash
rg -n "app ID|internal|public release|owner decision" docs/desktop/matter-desktop-packaging-decision.md
git diff --check -- docs/desktop/matter-desktop-packaging-decision.md docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
```
...
- Added `scripts/validate-matter-desktop-packaging.mjs`.

Check:

```bash
node scripts/validate-matter-desktop-packaging.mjs
git diff --check -- apps/desktop/electron-builder.yml apps/desktop/build/icon.svg scripts/validate-matter-desktop-packaging.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
```
...
- Added `scripts/build-matter-desktop-mac.mjs`.
- Added `build:mac` script to `apps/desktop/package.json`.
- Generated `docs/lazycodex/evidence/matter-desktop/artifacts/macos-build.md`.

Check:

```bash
npm --workspace apps/desktop run build:mac
git diff --check -- scripts/build-matter-desktop-mac.mjs apps/desktop/package.json docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md docs/lazycodex/evidence/matter-desktop/artifacts/macos-build.md
```
...
- Added `scripts/build-matter-desktop-win.mjs`.
- Added `build:win` script to `apps/desktop/package.json`.
- Generated `docs/lazycodex/evidence/matter-desktop/artifacts/windows-build.md`.

Check:

```bash
npm --workspace apps/desktop run build:win
git diff --check -- scripts/build-matter-desktop-win.mjs apps/desktop/package.json docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md docs/lazycodex/evidence/matter-desktop/artifacts/windows-build.md
```
...
- Added `docs/desktop/matter-desktop-update-policy.md`.

Check:

```bash
rg -n "internal|pilot|rollback|public|key rotation" docs/desktop/matter-desktop-update-policy.md
git diff --check -- docs/desktop/matter-desktop-update-policy.md docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
```
...
git diff --check -- apps/desktop/src/main/updates.js apps/desktop/test/update-rollback.test.mjs apps/desktop/package.json docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
```
...
- Added `docs/desktop/matter-desktop-license-audit.md`.
- Updated `apps/desktop/package.json` description to reflect current guarded desktop scope.

Check:

```bash
npm ls --workspace apps/desktop --json && rg -n "license|Electron|redistribution" docs/desktop/matter-desktop-license-audit.md
git diff --check -- docs/desktop/matter-desktop-license-audit.md apps/desktop/package.json docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
```
...
rg -n "MDT-P6|signed|rollback|public release" docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md
git diff --check -- docs/lazycodex/evidence/matter-desktop/lcx-desk-06-packaging-update.md docs/lazycodex/evidence/matter-desktop/artifacts/macos-build.md docs/lazycodex/evidence/matter-desktop/artifacts/windows-build.md
```
