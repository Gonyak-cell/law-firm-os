...
| TUW | Status | Evidence |
| --- | --- | --- |
| MDT-P2-W01-T01 | complete | `docs/desktop/matter-desktop-auth-session-plan.md` |
| MDT-P2-W01-T02 | complete | `contracts/desktop-deep-link-contract.json` |
| MDT-P2-W01-T03 | complete | `docs/desktop/matter-desktop-secure-store-policy.md` |
...
- Added `docs/desktop/matter-desktop-auth-session-plan.md`.

Check:

```bash
rg -n "PKCE|embedded password|renderer storage|forbidden" docs/desktop/matter-desktop-auth-session-plan.md
git diff --check -- docs/desktop/matter-desktop-auth-session-plan.md docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
- Updated `docs/desktop/matter-desktop-auth-session-plan.md`.

Check:

```bash
rg -n "auth_callback|mutation|download|upload|ai_generate" contracts/desktop-deep-link-contract.json
git diff --check -- contracts/desktop-deep-link-contract.json docs/desktop/matter-desktop-auth-session-plan.md docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
- Added `docs/desktop/matter-desktop-secure-store-policy.md`.

Check:

```bash
rg -n "token|logout|tenant switch|cache" docs/desktop/matter-desktop-secure-store-policy.md
git diff --check -- docs/desktop/matter-desktop-secure-store-policy.md docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
git diff --check -- contracts/desktop-session-cleanup-contract.json scripts/validate-desktop-session-cleanup-contract.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
git diff --check -- apps/desktop/src/main/auth.js apps/desktop/test/auth-coordinator.test.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
git diff --check -- apps/desktop/src/preload/session.js docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
...
git diff --check -- apps/desktop/package.json apps/desktop/src/main/auth.js apps/desktop/test/session-cleanup.test.mjs docs/lazycodex/evidence/matter-desktop/lcx-desk-02-auth-session.md
```
