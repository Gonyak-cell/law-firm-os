...
Generated at: 2026-06-25T15:16:39.197Z
...
| clients-denied | `/?locale=en&view=clients&data=live&ctx=denied` | 접근 권한이 없습니다, 권한이 있는 Client만 표시합니다 | PASS | locale=en; overflow=false; cards=0 |
| clients-review | `/?locale=en&view=clients&data=live&ctx=review` | 검토가 필요합니다, 검토가 끝나면 Client 정보를 확인할 수 있습니다 | PASS | locale=en; overflow=false; cards=0 |
