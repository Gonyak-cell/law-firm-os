...
Generated at: 2026-06-29T03:23:20.679Z
...
| --- | --- | --- | --- | --- |
| desktop-home-command-center | `/?locale=en&view=home&desktop=1&data=live&ctx=allow` | 고객, Matter, 구성원, Vault | PASS | locale=en; overflow=false; cards=4 |
| clients-live | `/?locale=en&view=clients&data=live&ctx=allow` | 고객, 담당자, Opportunity, 상담 이력 | PASS | locale=en; overflow=false; cards=0 |
...
| clients-denied | `/?locale=en&view=clients&data=live&ctx=denied#clients-list` | 접근 권한이 없습니다, 권한이 있는 고객만 표시합니다 | PASS | locale=en; overflow=false; cards=0 |
| clients-review | `/?locale=en&view=clients&data=live&ctx=review#clients-list` | 검토가 필요합니다, 검토가 끝나면 고객 정보를 확인할 수 있습니다 | PASS | locale=en; overflow=false; cards=0 |
