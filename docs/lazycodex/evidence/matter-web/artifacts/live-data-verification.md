...
Generated at: 2026-06-26T12:41:59.576Z
...
| client-data-cloud-live-surface-no-5xx | `/?locale=ko&view=clients&data=live&ctx=allow#client-data` | PASS | {"selector":"[data-cmp-g2-live-clients='true']","state_text":"Client Client와 상담 접수, 영업 기회를 한 화면에서 확인합니다. 새로고침 데이터 보강 Client 외부 연동 확인 중 연동 요청 동의와 보존 보강 범위는 담당자 승인 후 적용됩니다. 승인 확인 외부 연동 등록 아직 실행 전 동의 상태 아직 실행 전 외부 연동 정보를 불러오는 중입니다. 보강 미리보기 안전 출력 작업 생성 보강 작업 대기 미리보기 작업 상태 아직 실행 전 대상 대기 동의 대기 신뢰도 대기 외부 연결 ","api_5xx_count":0,"api_5xx":[]} |
| client-reports-live-surface-no-5xx | `/?locale=ko&view=clients&data=live&ctx=allow#client-reports` | PASS | {"selector":"[data-cmp-g2-live-clients='true']","state_text":"Client Client와 상담 접수, 영업 기회를 한 화면에서 확인합니다. 새로고침 보고서 Client 저장된 보고서 확인 중 생성 필터와 열 허용 필드 확인 조정 생성 상태 아직 실행 전 정의 상태 아직 실행 전 보고서 정보를 불러오는 중입니다. Client 손익 집계 수익성 새로고침 기존 Matter 집계에서만 Client 집계를 만듭니다. 새로고침 집계 상태 아직 실행 전 Client 손익 정보를 불러오는 중입니다. 실","api_5xx_count":0,"api_5xx":[]} |
