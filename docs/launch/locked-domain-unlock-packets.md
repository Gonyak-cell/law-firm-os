...
| `docs/launch/launch-external-receipt-ledger.md` | LCX7-RI-05 through LCX7-RI-12 receipts recorded; final go-live approval recorded; cutover and hypercare evidence remain pending |
...
| AI | LCX7-RI-12 receipt recorded; remains subject to G7 launch acceptance, AI governance validation, and final go-live | AI policy approval, source/citation policy, human-review routing, no-final-decision guard receipt |
