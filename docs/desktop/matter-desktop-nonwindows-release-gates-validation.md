...
- vault_document_writes_pending_owner_decision: true
...
- Vault document writes remain pending owner decision.
- Real client data migration remains pending owner decision.
- Public release, external pilot distribution, Windows Authenticode signing, company-wide rollout, Vault write execution, and real client migration execution remain out of scope.
