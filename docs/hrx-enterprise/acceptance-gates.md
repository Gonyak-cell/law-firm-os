...
Status: accepted
Date: 2026-06-20
Source: `docs/hrx-enterprise/roadmap-package/05_ACCEPTANCE_GATES.md`

## Global Rule

`runtime_api_evidence_only__durable_persistence_open` 상태에서는 go-live, R4, production-ready, enterprise-ready claim을 금지합니다.
