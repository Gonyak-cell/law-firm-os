...
Target repo folder map

## Acceptance Boundary

Each package has owner and R-level; evidence artifact linked; validator passes; no descriptor-only completion claim.
