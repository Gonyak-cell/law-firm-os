...
Main vs CMP branch baseline report

## Acceptance Boundary

R4 not claimed from branch evidence; evidence artifact linked; validator passes; no descriptor-only completion claim.
