...
CMP v1 TUW crosswalk validation

## Acceptance Boundary

Validator fails on missing/duplicate CMP TUW; evidence artifact linked; validator passes; no descriptor-only completion claim.
