...
People architecture ADR

## Acceptance Boundary

MatterTeam must reference Employee; evidence artifact linked; validator passes; no descriptor-only completion claim.
