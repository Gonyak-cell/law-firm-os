...
Billing profile ownership ADR

## Acceptance Boundary

Party/Billing boundary recorded; evidence artifact linked; validator passes; no descriptor-only completion claim.
