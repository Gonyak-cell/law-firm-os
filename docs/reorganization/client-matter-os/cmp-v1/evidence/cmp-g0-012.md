...
Event taxonomy freeze

## Acceptance Boundary

Every write and sensitive read mapped; evidence artifact linked; validator passes; no descriptor-only completion claim.
