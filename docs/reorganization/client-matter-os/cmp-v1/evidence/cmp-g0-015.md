...
Vault architecture ADR

## Acceptance Boundary

Vault owns docs/email/HR docs/RAG evidence; evidence artifact linked; validator passes; no descriptor-only completion claim.
