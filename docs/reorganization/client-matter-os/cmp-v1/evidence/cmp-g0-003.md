...
Canonical glossary freeze

## Acceptance Boundary

No term collision; User != Employee; evidence artifact linked; validator passes; no descriptor-only completion claim.
