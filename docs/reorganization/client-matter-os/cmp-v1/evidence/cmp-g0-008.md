...
PR discipline and review policy

## Acceptance Boundary

PR template includes TUW/evidence/R-claim checks; evidence artifact linked; validator passes; no descriptor-only completion claim.
