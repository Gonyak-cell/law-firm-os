...
API route standard freeze

## Acceptance Boundary

All write APIs define audit and idempotency; evidence artifact linked; validator passes; no descriptor-only completion claim.
