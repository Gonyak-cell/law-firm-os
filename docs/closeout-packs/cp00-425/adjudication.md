...
Review receipt: artifacts/closeout-pack-claude-review/cp00-425/review-receipt.json
...
Findings:
- CP00-425-P3-01 (P3): changed-file-scope dual-classifies the pack's own docs dir as both active-pack and unrelated
