...
Review receipt: artifacts/closeout-pack-claude-review/cp00-495/review-receipt.json
...
Findings:
- CP495-P3-01 (P3): authority_boundary.runtime_opening_pack_id names the next pack (CP00-496) while CP00-495 stays descriptor-only
