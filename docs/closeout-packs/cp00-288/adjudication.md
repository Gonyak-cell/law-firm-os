...
Review receipt: artifacts/closeout-pack-claude-review/cp00-288/review-receipt.json
...
Findings:
- CP00-288-P3-01 (P3): changed-file-scope.json dual-classifies pack evidence dir and handoff doc as both active-untracked and unrelated-preserved
