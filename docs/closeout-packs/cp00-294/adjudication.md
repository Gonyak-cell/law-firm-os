...
Review receipt: artifacts/closeout-pack-claude-review/cp00-294/review-receipt.json
...
Findings:
- P3-1 (P3): changed-file-scope.json double-classifies the pack's own artifact directory as 'unrelated'
