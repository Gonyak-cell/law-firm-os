...
Review receipt: artifacts/closeout-pack-claude-review/cp00-240/review-receipt.json
...
Findings:
- CP00-240-P3-001 (P3): CP240 case-set builder reuses CP239 row-extras instead of a dedicated CP240 constant
