...
Review receipt: artifacts/closeout-pack-claude-review/cp00-451/review-receipt.json
...
Findings:
- CP00-451-P3-001 (P3): changed-file-scope.json double-lists the pack's own evidence directory under unrelated_dirty_files_preserved
