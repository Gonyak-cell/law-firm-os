...
Review receipt: artifacts/closeout-pack-claude-review/cp00-431/review-receipt.json
...
Findings:
- CP431-P3-01 (P3): changed-file-scope labels the pack's own cp00-431 evidence directory as unrelated_dirty_files_preserved
