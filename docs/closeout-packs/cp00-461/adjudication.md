...
Review receipt: artifacts/closeout-pack-claude-review/cp00-461/review-receipt.json
...
Findings:
- CP461-P3-01 (P3): security_audit rows are descriptor-only stubs with no permission/audit-specific fields
