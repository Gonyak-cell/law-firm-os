...
Review receipt: artifacts/closeout-pack-claude-review/cp00-265/review-receipt.json
...
Findings:
- CP265-OBS-01 (P3): Post-review evidence artifacts referenced but not yet present (expected, gated by hardened review sequence)
