...
Review receipt: artifacts/closeout-pack-claude-review/cp00-310/review-receipt.json
...
Findings:
- CP310-P3-01 (P3): new-session-handoff.md dual-classified in changed-file-scope metadata
