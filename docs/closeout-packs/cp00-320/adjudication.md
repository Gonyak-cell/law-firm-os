...
Review receipt: artifacts/closeout-pack-claude-review/cp00-320/review-receipt.json
...
Findings:
- CP320-P3-01 (P3): Manifest forward-declares review-pipeline evidence artifacts not yet present at read-only review time
