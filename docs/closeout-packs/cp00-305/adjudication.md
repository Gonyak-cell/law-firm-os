...
Review receipt: artifacts/closeout-pack-claude-review/cp00-305/review-receipt.json
...
Findings:
- CP00-305-P3-01 (P3): changed-file-scope.json over-lists pack-owned and stray docs under unrelated_dirty_files_preserved
