...
Review receipt: artifacts/closeout-pack-claude-review/cp00-333/review-receipt.json
...
Findings:
- CP333-P3-01 (P3): changed-file-scope.json double-classifies the pack's own untracked artifact dir as unrelated_dirty_files_preserved
