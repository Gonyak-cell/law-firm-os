...
Review receipt: artifacts/closeout-pack-claude-review/cp00-516/review-receipt.json
...
Findings:
- CP00-516-P3-01 (P3): CP515/CP516 descriptor validators dropped the explicit matter_trace_required per-row guard present in the CP514 validator
