...
Review receipt: artifacts/closeout-pack-claude-review/cp00-494/review-receipt.json
...
Findings:
- CP494-P3-01 (P3): authority_boundary.runtime_opening_pack_id names the next pack while CP00-494 stays descriptor-only
