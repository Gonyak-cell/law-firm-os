...
Review receipt: artifacts/closeout-pack-claude-review/cp00-476/review-receipt.json
...
Findings:
- CP476-N1 (P3): Final-closeout adjudication/inspection/review-result artifacts are pending by design downstream of this read-only run
