...
Review receipt: artifacts/closeout-pack-claude-review/cp00-595/review-receipt.json
...
Findings:
- CP595-P3-01 (P3): P06 security/permission/ui rows resolve to bare descriptor placeholders, not runtime enforcement
