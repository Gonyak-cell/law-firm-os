...
Review receipt: artifacts/closeout-pack-claude-review/cp00-313/review-receipt.json
...
Findings:
- CP313-P3-001 (P3): changed-file-scope lists the active pack's own doc dir under unrelated_dirty_files_preserved
