...
Review receipt: artifacts/closeout-pack-claude-review/cp00-475/review-receipt.json
...
Findings:
- CP00-475-P3-01 (P3): changed-file-scope.json tags the pack's own evidence dir as an unrelated preserved file
