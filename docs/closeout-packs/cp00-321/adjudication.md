...
Review receipt: artifacts/closeout-pack-claude-review/cp00-321/review-receipt.json
...
Findings:
- CP00-321-P3-01 (P3): Claude review packet question text says 'twenty-one' descriptor sections but the pack defines twenty
- CP00-321-P3-02 (P3): command-evidence review_hardening.invalid_attempts_preserved is empty while the manifest preserves attempt-01
