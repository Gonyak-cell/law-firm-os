...
Review receipt: artifacts/closeout-pack-claude-review/cp00-515/review-receipt.json
...
Findings:
- CP00-515-P3-01 (P3): CP515 descriptor result uses RP16-style runtime-dispatch labels instead of RP17 AI-governance labels
