...
Review receipt: artifacts/closeout-pack-claude-review/cp00-411/review-receipt.json
Review verdict: PASS
...
Findings:
- CP00-411-P3-01 (P3): Manifest references post-review evidence artifacts that are not yet present (expected pre-review state)
