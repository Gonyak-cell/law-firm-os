...
Review receipt: artifacts/closeout-pack-claude-review/cp00-317/review-receipt.json
...
Findings:
- CP00-317-P3-001 (P3): changed-file-scope.json double-classifies an unrelated onboarding doc as an implementation file
