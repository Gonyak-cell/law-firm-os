...
Review receipt: artifacts/closeout-pack-claude-review/cp00-315/review-receipt.json
...
Findings:
- CP315-P3-01 (P3): changed-file-scope.json double-classifies the pack's own cp00-315 evidence dir and the session handoff doc
