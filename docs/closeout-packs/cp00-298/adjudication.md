...
Review receipt: artifacts/closeout-pack-claude-review/cp00-298/review-receipt.json
...
Findings:
- P3-1 (P3): changed-file-scope lists the pack's own cp00-298 artifact directory under unrelated_dirty_files_preserved
