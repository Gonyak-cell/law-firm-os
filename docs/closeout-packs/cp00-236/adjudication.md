...
Review receipt: artifacts/closeout-pack-claude-review/cp00-236/review-receipt.json
...
Findings:
- CP236-P3-01 (P3): M02 type/shape tail rows rely on generic descriptor checks only; row-specific semantic guards are asserted against the M03 copies
