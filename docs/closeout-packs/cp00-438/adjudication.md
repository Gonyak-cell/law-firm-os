...
Review receipt: artifacts/closeout-pack-claude-review/cp00-438/review-receipt.json
...
Findings:
- CP438-P3-01 (P3): Scope artifact labels the pack's own manifest dir under unrelated_dirty_files_preserved
