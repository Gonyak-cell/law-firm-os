...
Review receipt: artifacts/closeout-pack-claude-review/cp00-249/review-receipt.json
...
Findings:
- P3-1 (P3): changed-file-scope.json lists the pack's own evidence directory under unrelated_dirty_files_preserved
