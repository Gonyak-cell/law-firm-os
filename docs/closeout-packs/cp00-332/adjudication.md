...
Review receipt: artifacts/closeout-pack-claude-review/cp00-332/review-receipt.json
...
Findings:
- CP00-332-P3-01 (P3): audit_event_expectation row has no dedicated validator leak-guard
