...
Review receipt: artifacts/closeout-pack-claude-review/cp00-473/review-receipt.json
...
Findings:
- CP473-P3-01 (P3): Contract validator falls back to manifest snapshot when pack absent from authoritative plan
