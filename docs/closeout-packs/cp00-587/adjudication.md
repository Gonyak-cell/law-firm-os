...
Review receipt: artifacts/closeout-pack-claude-review/cp00-587/review-receipt.json
...
Findings:
- CP587-P3-01 (P3): CP587 descriptor validator lacks row-type-specific no-leak assertions for permission/audit rows
- CP587-P3-02 (P3): Manifest per-unit evidence_refs forward-reference post-review artifacts not yet present
