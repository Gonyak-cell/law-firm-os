...
Review receipt: artifacts/closeout-pack-claude-review/cp00-493/review-receipt.json
...
Findings:
- CP493-P3-01 (P3): Post-review evidence artifacts referenced by manifest are not present yet (expected by the hardening sequence)
