...
Review receipt: artifacts/closeout-pack-claude-review/cp00-483/review-receipt.json
...
Findings:
- CP483-P3-01 (P3): Closeout handoff open_scope mislabels next micro as "type and shape rows"
