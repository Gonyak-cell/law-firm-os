...
Review receipt: artifacts/closeout-pack-claude-review/cp00-248/review-receipt.json
...
Findings:
- CP00-248-P3-01 (P3): changed-file-scope.json classifies the pack's own evidence directory under unrelated_dirty_files_preserved
