...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5, P1 은행 입금 매출 7/7, P2 수임료·미수금 6/6 완료, P3 Outlook 문의·상담·수임 10/12 완료, 전체 28/53 완료
...
| `CL-P3-W03-T01` | 다음 | 수임 결정과 단계별 고객·수임료 반영 및 복구 명령 | 시작 전 |
