...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5 완료, 전체 9/53 완료
...
이 계획은 이전 33개 초안을 대체한다. v2 ID를 최초 실행 원장으로 사용하며, 2026-07-30에 P0의 5개 TUW와 P1의 첫 4개 TUW 구현·집중 검증을 완료했다.
...
| `CL-P1-W01-T05` | 다음 | 수동 연결·해제·입금자명 저장·동명이인 선택과 수동 연결 보호 | 시작 전 |
