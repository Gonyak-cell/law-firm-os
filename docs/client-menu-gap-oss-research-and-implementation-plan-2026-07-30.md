...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5, P1 은행 입금 매출 7/7, P2 수임료·미수금 6/6, P3 Outlook 문의·상담·수임 12/12, P4 Client 운영 조회 5/5 완료, P5 Client 10개 메뉴 1/11 완료, 전체 36/53 완료
...
이 계획은 이전 33개 초안을 대체한다. v2 ID를 최초 실행 원장으로 사용하며, 2026-07-31 현재 P0의 5개 TUW, P1의 7개 TUW, P2의 6개 TUW, P3의 M365 연결·원본 메일 증거·문의 등록·Outlook 추가 기능·문의 조회·상담·수임 결정·Intake 인계 12개 TUW, P4의 고객 권한 선필터·5개 KPI·오늘 확인할 일·12개월 추이·고객 순위·통합 대시보드 API 5개 TUW와 P5의 Client 메뉴·직접 주소 정리 1개 TUW를 구현·집중 검증했다.
...
| `CL-P5-W01-T02` | 다음 | 통합 대시보드 API의 5개 KPI와 오늘 확인할 일을 실제 상세 화면 이동과 원천별 상태 구분을 보존해 Client 대시보드에 연결 | 시작 전 |
