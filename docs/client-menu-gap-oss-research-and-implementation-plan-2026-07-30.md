...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5 완료, P1 파일 입력·고객 연결 5/5 완료, 전체 11/53 완료
...
이 계획은 이전 33개 초안을 대체한다. v2 ID를 최초 실행 원장으로 사용하며, 2026-07-30에 P0의 5개 TUW, P1의 파일 입력·고객 연결 5개 TUW와 환불 연결 1개 TUW 구현·집중 검증을 완료했다.
...
| `CL-P1-W02-T02` | 다음 | 확정 고객 입금과 연결 환불을 기준으로 고객별 순입금 매출·순위를 조회 | 시작 전 |
