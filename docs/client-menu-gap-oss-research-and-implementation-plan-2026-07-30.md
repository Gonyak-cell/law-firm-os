...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5, P1 은행 입금 매출 7/7, P2 수임료·미수금 6/6 완료, P3 Outlook 문의·상담·수임 4/12 완료, 전체 22/53 완료
...
| `CL-P3-W01-T04` | 다음 | Graph 원본 증거와 Party·Lead를 단계별 멱등 처리 기록으로 묶고 부분 실패 재실행을 검증 | 시작 전 |
