...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5 완료, P1 은행 입금 매출 7/7 완료, 전체 12/53 완료
...
이 계획은 이전 33개 초안을 대체한다. v2 ID를 최초 실행 원장으로 사용하며, 2026-07-30에 P0의 5개 TUW와 P1의 7개 TUW를 구현·집중 검증했다.
...
| `CL-P2-W01-T01` | 다음 | 수임료 약정 모델·Finance ID·중앙원장 관계·PostgreSQL 등록 | 시작 전 |
