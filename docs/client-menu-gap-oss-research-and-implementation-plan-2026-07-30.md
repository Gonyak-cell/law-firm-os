...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5, P1 은행 입금 매출 7/7, P2 수임료·미수금 6/6, P3 Outlook 문의·상담·수임 12/12, P4 Client 운영 조회 5/5 완료, P5 Client 10개 메뉴 8/11 완료, 전체 43/53 완료
...
| `CL-P5-W03-T01` | 진행 중 | 입금 매출 내역의 권한 선필터 목록·상세, 파일 preview·확정, 자동·수동 고객 연결, 환불 연결, version·멱등 영수증 기반 backend와 안전한 화면 모델을 구현하고 실제 API adapter·Client 화면 연결을 검증 중 | backend·모델 독립 재검토의 권한·영수증 차단 항목 수정 및 end-to-end UI 진행 중 |
