...
- 문서 상태: 구현 진행 중 — P0 기준 계약 5/5, P1 은행 입금 매출 7/7, P2 수임료·미수금 6/6, P3 Outlook 문의·상담·수임 12/12, P4 Client 운영 조회 5/5 완료, P5 Client 10개 메뉴 7/11 완료, 전체 42/53 완료
...
| `CL-P5-W02-T05` | 진행 중 | 상담·수임 관리와 접촉 이력의 예약·일정 변경·완료·Outlook 일정 연결·수임 결정·복구·일반 메모를 기존 CRM 계약에 연결 | 구현·검증 진행 중 |
