...
- Status: `DONE`
- Report verdict: `BLOCKED_AUTHENTICODE`
...
- Renderer files: `28`
- Evidence links checked: `18/18`
- Missing evidence links: `0`

QA-001 through QA-005, QA-007, and QA-008 are complete and PASS. QA-006 proves native Windows install, launch, login, leave, payroll, restart, and uninstall, but remains BLOCKED because the installer and unpacked executable are both `NotSigned`. The integration branch is therefore not eligible for a `main` merge, public release, or production go-live under the canonical plan.
