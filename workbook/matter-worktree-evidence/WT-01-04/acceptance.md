...
Status: implementation, targeted tests, Matter regression, SQL syntax QA, restart QA, and evidence complete; isolated commit pending because the current sandbox cannot write `.git/index.lock`.
