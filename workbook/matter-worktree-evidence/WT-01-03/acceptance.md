...
Status: implementation, targeted tests, Matter regression, library manual QA, and evidence complete. Canonical evidence commit: `d5df34d37`; the historical `.git/index.lock` wait is resolved.
