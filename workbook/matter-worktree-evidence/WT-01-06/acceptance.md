...
Status: implementation, targeted tests, Matter regression, manual library QA, and evidence complete. Canonical evidence commit: `18fc38cb6`; the historical `.git/index.lock` wait is resolved.
